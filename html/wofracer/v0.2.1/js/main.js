...
/*
    ...
    Some code incorporated from:   
        Convert seconds to HH:mm:ss : https://stackoverflow.com/a/25279340
...
const statTypes = ['emission_rate', 'fuel_efficiency', 'max_capacity', 'max_range', 'max_speed'];

var adjustablesVM = null;
var bound = [];
var isPaused = false;
var lesseeVehiclesVM = ko.observableArray();
var logCounter = 0;

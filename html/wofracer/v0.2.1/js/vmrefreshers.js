...
function assignUserVehicles()
{
    ...
    */
    ...
    if (vehiclePermutationFinalTimes.length > 0)
    {
        ...
        selectedVehicle = availableVehiclesInClass.find(vehicle => { return vehicle.token_id() == vehiclePermutationIdWithShortestTime.split('_')[0]; });
        ...
        if (selectedVehicle.SelectedPermutation != null)
        {
            ...
            selectedVehicle.ApplyUpgradesNowClass = ko.observable('link-apply-upgrades');
            selectedVehicle.ApplyUpgradesNowText = ko.observable('Apply Upgrades Now');
            checkApplyUpgradesNowLink(unjoinedRace, selectedVehicle);
        }
        else
        {
            selectedVehicle.ApplyUpgradesNowClass = ko.observable('');
            selectedVehicle.ApplyUpgradesNowText = ko.observable('No Upgrades to Apply');
    ...
    if (selectedVehicle.vehicleId != unjoinedRace.selectedVehicle().vehicleId)
    {
...
function checkApplyUpgradesNowLink(selectedRace, vehicle)
{
    try
    {
        ...
        if ((selectedPermutation != null) && (selectedPermutation.comboUpgrades != null))
        {
            ...
            //const applyUpgradesNowTextSubstring = selectedRace.selectedVehicle().ApplyUpgradesNowText().substring(0, 3).toLowerCase();
    ...
    unjoinedRaces.forEach( (unjoinedRaceItem, index) =>
        {
            ...
            if (unjoinedRaceFromVm != null) unjoinedRaces[index] = unjoinedRaceFromVm;
/*
...
*/                
                ...
                preSelectedVehicle = ko.mapping.fromJS(
                    {
                        ApplyUpgradesNowClass: 'link-apply-upgrades',
                        ApplyUpgradesNowText: 'Apply Upgrades Now',
                        numberOfRefuels: 0, 
                        numberOfTrips: 0, 
                ...
                //checkApplyUpgradesNowLink(unjoinedRaces[index], unjoinedRaces[index].PreSelectedVehicle);
